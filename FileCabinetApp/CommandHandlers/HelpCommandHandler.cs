...
namespace FileCabinetApp.CommandHandlers
{
    ...
    public class HelpCommandHandler : CommandHandlerBase
    {
        ...
        private static readonly string[][] HelpMessages = new string[][]
        {
            ...
            new string[] { "select", "selects records with SQL-like syntax", "The 'select' command updates records with SQL-like syntax. Example 'select' command: select id, firstname, lastname where firstname = 'John' and lastname = 'Doe'" },
