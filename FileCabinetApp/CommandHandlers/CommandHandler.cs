...
namespace FileCabinetApp.CommandHandlers
{
    ...
    public class CommandHandler : CommandHandlerBase
    {
        ...
        private static void Create(string parameters)
        {
            ...
            int recordId = Program.FileCabinetService.CreateRecord(recordToCreate);
        ...
        private static void Edit(string parameters)
        {
            ...
            try
            {
                Program.FileCabinetService.GetRecordById(id);
            }
            catch
            {
                Console.WriteLine($"#{parameters} record is not found.");
            ...
            recordToEdit.Id = id;
            Program.FileCabinetService.EditRecord(recordToEdit);
        ...
        private static void Find(string parameters)
        {
            ...
            {
                "firstname" => Program.FileCabinetService.FindByFirstName(searchText),
                "lastname" => Program.FileCabinetService.FindByLastName(searchText),
                "dateofbirth" => Program.FileCabinetService.FindByDateOfBirth(searchText),
                _ => null,
            };
                ...
                switch (fileFormat)
                {
                    case "csv":
                        using (var reader = new StreamReader(path))
                        {
                            ...
                            int countOfRestoredrecords = Program.FileCabinetService.Restore(snapshot);
        ...
        private static void Remove(string parameters)
        {
            ...
            if (Program.FileCabinetService.Remove(recordId))
            {
