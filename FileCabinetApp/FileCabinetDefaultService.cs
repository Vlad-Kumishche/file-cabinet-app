...
namespace FileCabinetApp
{
    ...
    public class FileCabinetDefaultService : FileCabinetService
    {
        ...
        protected override void ValidateName(string? line)
        {
        ...
        protected override void ValidateHeight(short height)
        {
        ...
        protected override void ValidateCashSavings(decimal cashSavings)
        {
        ...
        protected override void ValidateLetter(char c)
        {
            if ((c < 'a' || c > 'z') && (c < 'A' || c > 'Z'))
            {
